 ...
 */
public class highScore extends ActionBarActivity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        sensorAccelerometer = sensorManager.getDefaultSensor(Sensor.TYPE_GYROSCOPE);
