 ...
 */
public class Taxview extends View implements Shake.OnShakeListener{
    ...
    private long mMoveDelayReset;
    private Context context;
    private Matrix matrix;
    private AccelerometerListener accelerometerListener;
    private Shake shakeListener;
    private boolean mListening;
    private ImageView mGameOverImage;
    ...
    public Taxview(Context context, AttributeSet attributes) {
        ...
        shakeListener = new Shake(this);
        mMoveDelayReset = mMoveDelay;
    ...
    public void setGameOverScreen(ImageView image){
        mGameOverImage = image;
    }

    public void startAnimation() {
        taxModel.setState(State.READY);
        this.update();
    }
    ...
    private void initModel() {
        ...
        taxModel = new Taxmodel(tilesX, tilesY, context, mGameOverImage);
        calculateMetrics();
    ...
    @Override
    public void onShake() {
        Log.d("Shake", "Shaking registered, restarting if State is lose");
        if(taxModel != null && taxModel.getState() == State.LOSE){
            mMoveDelay = mMoveDelayReset;
            startAnimation();
        }
    ...
    public void startListening(SensorManager manager) {
        if (!mListening) {
            ...
            manager.registerListener(shakeListener, accelerometer, SensorManager.SENSOR_DELAY_FASTEST);
            mListening = true;
        }
    }
